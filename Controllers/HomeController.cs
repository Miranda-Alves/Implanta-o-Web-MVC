...
public class HomeController : Controller
{
    ...
    public IActionResult Index()
    {
       ...
       Cliente cliente2 = new Cliente(02, "William Henry Gates 111","039.618.250-09", "bill@microsoft.com", "Bug");
      ...
      ViewBag.listaCliente = listaClientes;
      ...
      Fornecedor fornecedor3 = new Fornecedor(03, "BootsPet INC","40.810.224/0001-83", "boots.pets@gatomania.us");
      Fornecedor fornecedor4 = new Fornecedor(04,"Tik Tok Dogs","87.945.350/0001-09", "noisnamidia@tiktokdogs.uk");
      Fornecedor fornecedor5 = new Fornecedor(05, "Bifinho Forever","18.760.614/001-37","contato@bff.us");
